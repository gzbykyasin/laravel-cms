...
@section('content')
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Video Galeri</h3>
                        <p class="text-muted m-b-30 font-13">Sitede kullanılan tüm videoları buradan görebilirsiniz </p>
                        <div class="table-responsive">
                            <table id="myTable" class="table table-striped">
                                <thead>
                                <tr>
                                    <th>Video Galeri İsmi</th>
                                    <th>Video Galeri Açıklama</th>
                                    <th>İşlemler</th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('admin/video/'.$video->id.'/edit')}}" class="fcbtn btn btn-outline btn-info btn-1b">Düzenle</a>
