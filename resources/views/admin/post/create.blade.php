...
@section('content')
    ...
    <form method="post" action="{{url('admin/yazi')}}" enctype="multipart/form-data">
    {!! csrf_field().method_field('post') !!}
    <!-- .row -->
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title m-b-0">Yazı Ekle</h3>
                    <p class="text-muted m-b-30 font-13"> Sitenin yazılar sayfasını buradan oluşturabilirsiniz </p>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" placeholder="Yazı için yazar etiketi" id="example-text-input" name="author">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label  class="col-2 col-form-label">Title</label>
                        <div class="col-10">
                            <input class="form-control" type="text" placeholder="Yazı SEO Title" id="example-text-input" name="title" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label  class="col-2 col-form-label">Description</label>
                        <div class="col-10">
                            <textarea class="form-control" rows="3" name="description" placeholder="Yazı SEO Description" required></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label  class="col-2 col-form-label">Keywords</label>
                        <div class="col-10">
                            <textarea class="form-control" rows="3" name="keywords" required placeholder="Yazı SEO Keywords"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
