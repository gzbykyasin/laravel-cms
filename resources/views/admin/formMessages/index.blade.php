...
@section('content')
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Form Mesajları</h3>
                        <p class="text-muted m-b-30 font-13">Sitede gönderilen tüm form mesajlarını buradan görebilirsiniz </p>
                        <div class="table-responsive">
                            <table id="myTable" class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>{{$form->email}}</td>
                                    <td>
                                        <a href="{{url('admin/formlar/'.$form->id)}}" class="btn btn-outline-warning"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
